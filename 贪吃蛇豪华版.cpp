...
int gaming()
{
    ...
    while(1)
    {
        ...
        {
            go(0,yl+2);color(79);printf("You are dead！");
            go(0,yl+4);pdot();color(240);printf("One more chance");
            go(0,yl+5);pdot();color(15);printf("return to the main menu");
            key=0;
            int a=0;
            while(key!=13)
            {
                ...
                if(key==224)
                {
                    key=getch();
                    if(key==72||key==80) a=1-a;
                    if(a==0) go(0,yl+4),pdot(),color(240),printf("One more chance"),go(0,yl+5),pdot(),color(15),printf("return to the main menu");
                    else go(0,yl+4),pdot(),color(15),printf("One more chance"),go(0,yl+5),pdot(),color(240),printf("return to the main menu");
                }
            }
